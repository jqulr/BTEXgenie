...
* [KOfam database download](#kofam-database-download)
* [Usage](#usage)
...
> Optional --window-size can be used to control the window size for displaying GC skew and KOfam hit density across the input genome (Default: 5000bp).
